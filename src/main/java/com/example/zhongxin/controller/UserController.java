package com.example.zhongxin.controller;


import com.example.zhongxin.dao.UsersMapper;
import com.example.zhongxin.enums.OperatorFriendRequestTypeEnum;
import com.example.zhongxin.enums.SearchFriendsStatusEnum;
import com.example.zhongxin.pojo.Users;
import com.example.zhongxin.pojo.bo.UsersBO;
import com.example.zhongxin.pojo.vo.MyFriendsVO;
import com.example.zhongxin.pojo.vo.UsersVO;
...
import com.example.zhongxin.utils.IMoocJSONResult;
import com.example.zhongxin.utils.MD5Utils;
...
//        System.out.println(user);
	...
	public IMoocJSONResult uploadFaceBase64(@RequestBody UsersBO userBO) throws Exception {
		...
		//windows下的路径
//		String userFacePath = "E:\\picture\\head\\" + userBO.getUserId() + "userface64.png";
		//linux下的路径
		String userFacePath = "//home//ubuntu//picture//head//" + userBO.getUserId() + "userface64.png";
...
//		"dhawuidhwaiuh3u89u98432_80x80.png"
	...
	public IMoocJSONResult getUnReadMsgList(String acceptUserId) {
		...
		// 查询列表
		List<com.example.zhongxin.pojo.ChatMsg> unreadMsgList = userService.getUnReadMsgList(acceptUserId);

		return IMoocJSONResult.ok(unreadMsgList);
	}

	@GetMapping("/findAllUser")
	public ModelAndView ModelAndView(Map<String, Object> map){
	...
	public ModelAndView deleteUser(@RequestParam("userId")String userId,Map<String, Object> map){
